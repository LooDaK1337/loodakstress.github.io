									...
									<div class="col-sm-12">
										...
										<label for="private">Rank</label>
											<select class="form-control" id="private" name="rank">
                                                                                                <option value="93" <?php echo selectedR(93, $rank); ?> >Fondateur</option>
                                                                                                <option value="92" <?php echo selectedR(92, $rank); ?> >Developpeur</option>
												<option value="1" <?php echo selectedR(1, $rank); ?> >Administrator</option>
												<option value="2" <?php echo selectedR(2, $rank); ?> >Supporter</option>
												<option value="3" <?php echo selectedR(3, $rank); ?> >Premium</option>
								                <option value="4" <?php echo selectedR(4, $rank); ?> >PremiumV2 </option>
